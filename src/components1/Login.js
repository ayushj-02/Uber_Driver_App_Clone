...
onSignInSubmit(e){
  ...
  onSignInSubmit=(e)=>{
    ...
    const phoneNumber = this.state.countryCodeValue+this.state.mobile;
  ...
  render(){
    return(
      ...
      <h3>What's your phone number or email?</h3>
        ...
        <form className="page" onSubmit={this.onSignInSubmit}>
          <div className="sign-in-button"></div>
            <div className="tel-box">
              ...
              <span className='cntrycode' defaultValue={this.state.countryCodeValue}>{`+${this.state.countryCodeValue}`}</span>
        ...
        <p className='l-lead'>By proceeding, you consent to get calls,WhatsApp or SMS messages, including by automated means, from Uber and its affliates to the nuber provided.</p>
      </div>
    )
  }
}
